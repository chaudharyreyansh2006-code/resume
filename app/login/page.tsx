...
function LoginFormWithSearchParams() {
  ...
  // Check if user is already authenticated and redirect to upload
  // Remove or comment out this useEffect in LoginFormWithSearchParams
  // useEffect(() => {
      ...
      <main className="flex-1 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div className="w-full max-w-md space-y-8">
          <div className="space-y-2 text-center">
            <h1 className="text-4xl font-semibold tracking-tight text-black">Welcome to CVFolio.Me</h1>
