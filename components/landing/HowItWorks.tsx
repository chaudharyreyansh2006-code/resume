      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="relative">
          <div className="grid lg:grid-cols-3 gap-8 lg:gap-12 relative">
            ...
            {/* Step 2 */}
            <div className="bg-white rounded-2xl p-8 shadow-sm border-4 border-gray-200 backdrop-blur transform rotate-2 sm:rotate-3 relative z-10 hover:rotate-0 transition-transform duration-300">
              <div className="mb-6">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm border-4 border-gray-200 backdrop-blur transform -rotate-2 sm:-rotate-3 relative z-10 hover:rotate-0 transition-transform duration-300">
              ...
              <p className="text-gray-600 leading-relaxed">
                Get your custom cvfolio.me/yourname URL and start impressing employers with your professional online
                presence.
              </p>
            </div>
          </div>
