  ...
  switch (theme) {
    case 'zinc':
      return {
        ...
        accentClass: 'text-[#fafafa] border-[#27272a]',
        primaryTextClass: 'text-[#fafafa]',
        secondaryTextClass: 'text-[#a1a1aa]',
        mutedTextClass: 'text-[#71717a]',
        linkClass: 'text-[#fafafa] hover:text-[#d4d4d8]',
    ...
    case 'zen-garden':
      return {
        ...
        cardClass: 'bg-[#212c21] border-[#4d90b3] shadow-lg rounded-lg',
        accentClass: 'text-[#edf4f7] border-[#4d90b3]',
        primaryTextClass: 'text-[#e7efe7]',
        secondaryTextClass: 'text-[#a7c3a7]',
        mutedTextClass: 'text-[#7a9a7a]',
        linkClass: 'text-[#4d90b3] hover:text-[#6ba3d0]',
        badgeClass: 'bg-[#2d4a2d] border-[#4d90b3]',
